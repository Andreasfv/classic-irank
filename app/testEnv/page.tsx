...
export default function Home() {
  ...
  const testZones = useAction(api.warcraftlogs.actions.generateZonesAndEncounters.generateZonesAndEncounters)
  
  async function handleZoneTest() {
    await testZones()
  }
  return (
